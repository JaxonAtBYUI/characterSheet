...
function renderDashboard(template, item){
  ...
  template.querySelector(".cls").innerHTML = item.
  template.querySelector(".lvl").innerHTML
  template.querySelector(".bg").innerHTML
  template.querySelector(".ac").innerHTML
  template.querySelector(".initiative").innerHTML
  template.querySelector(".speed").innerHTML
